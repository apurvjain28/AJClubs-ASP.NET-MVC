...
{
    public class AJCountriesController : Controller
    {
        private readonly AJClubsContext _context;

        public AJCountriesController(AJClubsContext context)
        {
            _context = context;
        }
        ...
        // GET: AJCountries/Edit/5
        // edit the details in an existing country
